/* 
    This is a modified version of the EaglerForge mod GUI for the little screen of EaglerForge Builder
*/
...
function displayGui() {
  function gui() {
    ...
    scaleContainer.id = "eaglerpl_gui_scale";
    scaleContainer.style = `width:100%; height: 100%; color: white; font-family: Minecraftia, sans-serif; overflow-y: scroll; overflow-x: hidden;`;
    if (location.hash === "#embed") {
        scaleContainer.style.transform = "scale(0.75)";
    }
    ...
    scaleContainer.appendChild(warningPoster);
    ...
    scaleContainer.appendChild(tipPoster);
    ...
    scaleContainer.appendChild(addBtn);
    scaleContainer.appendChild(uploadBtn);
    ...
    scaleContainer.appendChild(notice);
